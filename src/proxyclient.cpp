...
ProxyClient::ProxyClient(const UDPTunnelConnectionSettings& udpTunnelConnectionSettings)
{
    ...
    QObject::connect(this->udpTunnelConnection.get(), &UDPTunnelConnection::bytesReceived, this, [this](const QByteArray& payload){
        this->tcpClient.handleUdpTunnelPacket(payload);
    });
    QObject::connect(&this->tcpClient, &TCPClient::connected, this, [this](const size_t& connectionId){
    ...
    QObject::connect(&this->tcpClient, &TCPClient::disconnected, this, [this](const size_t& connectionId){
        TCPTunnelPacketHeader header;
        header.setConnectionId(connectionId);
    ...
    QObject::connect(&this->tcpClient, &TCPClient::bytesWritten, this, [this](const size_t& connectionId){
        TCPTunnelPacketHeader header;
        header.setConnectionId(connectionId);
    ...
    QObject::connect(&this->tcpClient, &TCPClient::bytesReceived, this, [this](const size_t& connectionId, const QByteArray& payload){
        TCPTunnelPacketHeader header;
        header.setConnectionId(connectionId);
...
ProxyClient::~ProxyClient()
{
    ...
    QObject::disconnect(&this->tcpClient, &TCPClient::connected, this, nullptr);
    QObject::disconnect(&this->tcpClient, &TCPClient::disconnected, this, nullptr);
    QObject::disconnect(&this->tcpClient, &TCPClient::bytesWritten, this, nullptr);
    QObject::disconnect(&this->tcpClient, &TCPClient::bytesReceived, this, nullptr);
}
